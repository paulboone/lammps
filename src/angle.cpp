                     ...
                     double delx2, double dely2, double delz2)
{
  ...
  if (hflag_global || hflag_atom) {
    ...
    if (hflag_global) {
      // WARNING: this part only works when there are NO ghost atoms
      // I've left it here temporarily for use with verifying the other algorithm.
      // TODO: delete hflag_global block and compute
